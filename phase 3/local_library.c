...
Book books[] = {
{1001, "Sun Don't Shine", 40, ADULT,E_DRAMA,.gp.drama = {1,3}},
{1002, "Irma la dos", -100, DOCUMENTARY,E_THILLER,.gp.thrilling_factor=5},
{1003, "Starship Troopers: Invasion", -68, KIDS,E_HOMUR,.gp.homur={4,'g'}},
{1004, "Year of the Jellyfish", 5, ADULT,E_NON_FICTION,.gp.non_fiction=1},
...
unsigned short num_books()
{
	return(sizeof(books)/sizeof(Book));
}
size_t i;
const char * gets_book(unsigned short internal)
{
